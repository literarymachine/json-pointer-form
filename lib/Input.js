...
class Input extends FormElement {
  ...
  getInput(name, value, handleChange, isFirst) {
    return (
      <div className={`${this.props.rows > 1 ? "textarea " : (this.props.type || "input")} ${this.props.property} ${this.props.className || ""}`}>
        ...
        {this.props.rows > 1 ? (
          <textarea
            ...
            placeholder={this.props.getLabel(this.props.property)}
          />
        ) : (
          <input
